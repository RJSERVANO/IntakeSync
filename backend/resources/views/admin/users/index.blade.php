                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.users.edit', $user) }}"
                                       data-action="edit"
                                       class="action-btn p-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form method="POST" action="{{ route('admin.users.destroy', $user) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                        ...
                                        <button type="submit"
                                                data-action="delete"
                                                class="action-btn p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
